...
struct AquariumTemp2 : Identifiable, Hashable {
    var id = UUID()
    var name: String
    var fishes: [String]
}

struct AquariumGame2_View: View {
    
    @State var aquariums: [AquariumTemp2] = [AquariumTemp2(name: "Aquarium 1", fishes: ["🐟"])]
                    ...
                    VStack{
                        ScrollView {
                            ...
                            if isEdit {
                                Button {
                                    aquariums.append(
                                        AquariumTemp2(name: "Aquarium \(aquariums.count+1)", fishes: [])
                                    )
                                } label: {
...
struct AquariumGame2_View_Previews: PreviewProvider {
    static var previews: some View {
        AquariumGame2_View(levelId: 0, hintCount: 0)
    }
}
